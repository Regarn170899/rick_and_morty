      ...
      {currentChar && (
        <div className={styles.singleCharContainer}>
          <div className={styles.singleCharCard}>
            <div
              onClick={(e) => handelClickFav(currentChar)}
              className={styles.favorite}
            >
              {currentChar.isFavorite ? <ColoredStar /> : <TransparentStar />}
            </div>
            <img
              className={styles.singleCharImg}
            ...
            <div className={styles.descriptionContainer}>
              <div className={styles.textContainer}>
                ...
                <span>Gender:{currentChar.gender}</span>
                <span>Planet:{currentChar.origin.name}</span>
              </div>
